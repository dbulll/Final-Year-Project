...
<div class="container">
  <div class="row">
    <a class="btn btn-nav" id="storyBacklogButton" href="storyBacklog.php" style="margin-bottom: 10px;"><span class="glyphicon glyphicon-arrow-left"></span> Story Backlog
    </a>
    <a class="btn btn-nav pull-right" id="releasePlanningButton" href="releasePlanning.php" style="margin-bottom: 10px;">Release Planning <span class="glyphicon glyphicon-arrow-right"></span>
    </a>
  </div>
  <?php 
